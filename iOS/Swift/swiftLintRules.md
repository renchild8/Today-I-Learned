...
| control_statement | no | no | yes | style | no | warning |
...
| deployment_target | no | no | yes | lint | no | warning,iOS_deployment_target:7.0,macOS_deployment_target:10.9,watchOS_deployment_target:1.tvOS_deployment_target:9.0 |
...
| line_length | no | no | yes | metrics | no | warning:120,error:200,ignoresurls:false,ignoresfunctiondeclarations:false,ignorescomments:falsignoresinterpolatedstrings:false |
